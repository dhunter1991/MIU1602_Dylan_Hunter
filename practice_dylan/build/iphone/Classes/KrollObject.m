...
//@interface practice_dylanObject : NSObject
//@end

@interface practice_dylanObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[practice_dylanObject class]])
		{
			for (NSString *key in [[(practice_dylanObject*)o modules] allKeys])
			{
