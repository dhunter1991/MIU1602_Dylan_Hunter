...
//Rare exceptions to indicate a bug in the _practice_dylan code (Eg, function that a subclass should have implemented)
...
/**
 The base class for practice_dylan proxies.
 */
