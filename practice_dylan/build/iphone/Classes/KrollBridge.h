...
@interface practice_dylanObject : KrollCoverageObject {
#else
@interface practice_dylanObject : KrollObject {
#endif
@private
...
extern NSString * practice_dylan$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	practice_dylanObject *_practice_dylan;
    KrollObject* console;
	BOOL shutdown;
