...
/**
 Base class for all practice_dylan views.
 @see TiViewProxy
 */
#ifdef TI_USE_AUTOLAYOUT
...
/**
 Whether or not a view not normally picked up by the practice_dylan view hierarchy (such as wrapped iOS UIViews) was touched.
