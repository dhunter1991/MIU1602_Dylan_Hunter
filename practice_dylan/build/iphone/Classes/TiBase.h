...
// in simulator we redefine to format for practice_dylan Developer console
...
{\
	NSString * exceptionName = [@"org.practice_dylan." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.practice_dylan";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIpractice_dylanNativeItemNone = -1, 
	UIpractice_dylanNativeItemSpinner = -2,
	UIpractice_dylanNativeItemProgressBar = -3,
	
	UIpractice_dylanNativeItemSlider = -4,
	UIpractice_dylanNativeItemSwitch = -5,
	UIpractice_dylanNativeItemMultiButton = -6,
	UIpractice_dylanNativeItemSegmented = -7,
	
	UIpractice_dylanNativeItemTextView = -8,
	UIpractice_dylanNativeItemTextField = -9,
	UIpractice_dylanNativeItemSearchBar = -10,
	
	UIpractice_dylanNativeItemPicker = -11,
	UIpractice_dylanNativeItemDatePicker = -12,
	
	UIpractice_dylanNativeItemInfoLight = -13,
	UIpractice_dylanNativeItemInfoDark = -14,
	
	UIpractice_dylanNativeItemDisclosure = -15,
	
	UIpractice_dylanNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all practice_dylan instances of
