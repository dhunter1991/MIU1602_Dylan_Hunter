...
//Rare exceptions to indicate a bug in the _k1602_aboutme_hunter_dylan code (Eg, function that a subclass should have implemented)
...
/**
 The base class for k1602_AboutMe_Hunter_Dylan proxies.
 */
