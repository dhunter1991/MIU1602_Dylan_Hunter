...
@interface k1602_InfoApp_Hunter_DylanObject : KrollCoverageObject {
#else
@interface k1602_InfoApp_Hunter_DylanObject : KrollObject {
#endif
@private
...
extern NSString * k1602_InfoApp_Hunter_Dylan$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	k1602_InfoApp_Hunter_DylanObject *_k1602_infoapp_hunter_dylan;
    KrollObject* console;
	BOOL shutdown;
