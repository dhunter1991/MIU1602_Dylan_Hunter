...
// in simulator we redefine to format for k1602_InfoApp_Hunter_Dylan Developer console
...
{\
	NSString * exceptionName = [@"org.k1602_infoapp_hunter_dylan." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.k1602_infoapp_hunter_dylan";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIk1602_InfoApp_Hunter_DylanNativeItemNone = -1, 
	UIk1602_InfoApp_Hunter_DylanNativeItemSpinner = -2,
	UIk1602_InfoApp_Hunter_DylanNativeItemProgressBar = -3,
	
	UIk1602_InfoApp_Hunter_DylanNativeItemSlider = -4,
	UIk1602_InfoApp_Hunter_DylanNativeItemSwitch = -5,
	UIk1602_InfoApp_Hunter_DylanNativeItemMultiButton = -6,
	UIk1602_InfoApp_Hunter_DylanNativeItemSegmented = -7,
	
	UIk1602_InfoApp_Hunter_DylanNativeItemTextView = -8,
	UIk1602_InfoApp_Hunter_DylanNativeItemTextField = -9,
	UIk1602_InfoApp_Hunter_DylanNativeItemSearchBar = -10,
	
	UIk1602_InfoApp_Hunter_DylanNativeItemPicker = -11,
	UIk1602_InfoApp_Hunter_DylanNativeItemDatePicker = -12,
	
	UIk1602_InfoApp_Hunter_DylanNativeItemInfoLight = -13,
	UIk1602_InfoApp_Hunter_DylanNativeItemInfoDark = -14,
	
	UIk1602_InfoApp_Hunter_DylanNativeItemDisclosure = -15,
	
	UIk1602_InfoApp_Hunter_DylanNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all k1602_InfoApp_Hunter_Dylan instances of
