...
/**
 Base class for all k1602_InfoApp_Hunter_Dylan views.
 @see TiViewProxy
 */
#ifdef TI_USE_AUTOLAYOUT
...
/**
 Whether or not a view not normally picked up by the k1602_InfoApp_Hunter_Dylan view hierarchy (such as wrapped iOS UIViews) was touched.
