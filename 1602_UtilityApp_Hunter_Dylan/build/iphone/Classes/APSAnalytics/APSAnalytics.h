 ...
 * to send analytic data that can be viewed on the k1602_UtilityApp_Hunter_Dylan Dashboard.
 *
 * For information on getting started with k1602_UtilityApp_Hunter_Dylan Platform Services,
