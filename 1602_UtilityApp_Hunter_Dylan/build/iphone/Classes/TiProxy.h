...
//Rare exceptions to indicate a bug in the _k1602_utilityapp_hunter_dylan code (Eg, function that a subclass should have implemented)
...
/**
 The base class for k1602_UtilityApp_Hunter_Dylan proxies.
 */
