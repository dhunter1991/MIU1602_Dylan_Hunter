...
//@interface k1602_UtilityApp_Hunter_DylanObject : NSObject
//@end

@interface k1602_UtilityApp_Hunter_DylanObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[k1602_UtilityApp_Hunter_DylanObject class]])
		{
			for (NSString *key in [[(k1602_UtilityApp_Hunter_DylanObject*)o modules] allKeys])
			{
